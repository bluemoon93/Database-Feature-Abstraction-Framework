...
public class S_Customers2 implements IS_Customers2{
...
public static final int COMMIT=-21, RB=-23, AUTOCOMMIT=-26,
	...
	public S_Customers2(IBusinessManager man, ObjectOutputStream oos, ObjectInputStream ois, String crud, Integer sessionID, Integer querySRID, IBusinessSchemaController controller, Integer activeSequence) throws SQLException {
	if(!controller.validateExecution(activeSequence, "S_Customers_byName.IS_Customers2")) {
		throw new SequenceException("IS_Customers2 was used out of order!");
	}
