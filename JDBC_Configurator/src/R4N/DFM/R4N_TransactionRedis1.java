 ...
 * @author bluemoon
 */
public class R4N_TransactionRedis1 extends R4N_Transaction {
    ...
    public R4N_TransactionRedis1(Connection conn, String id, FTHandler f, ConcurrencyHandler ch) throws Exception {
        super(conn, id,f,ch);
    }
